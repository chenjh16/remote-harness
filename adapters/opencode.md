...
builds/tests on whichever machine hosts the code. The skill auto-detects the direction (then
confirms): **reverse** = you're on a remote box, code on my laptop behind NAT (reverse tunnel);
